...
from app.core.auth import DEFAULT_PLAN, resolve_chatgpt_account_id, extract_id_token_claims
...
class AuthManager:
    ...
    async def refresh_account(self, account: Account) -> Account:
        ...
        if result.account_id and not account.chatgpt_account_id:
...
def _chatgpt_account_id_from_id_token(id_token: str) -> str | None:
    ...
    return resolve_chatgpt_account_id(claims=claims)
