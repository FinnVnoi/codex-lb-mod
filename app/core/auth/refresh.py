...
from app.core.auth import resolve_chatgpt_account_id, extract_id_token_claims
...
async def refresh_access_token(
    ...
    *,
    ...
    account_id = resolve_chatgpt_account_id(claims=claims)
    plan_type = (auth_claims.chatgpt_plan_type if auth_claims else None) or claims.chatgpt_plan_type
    email = claims.email
