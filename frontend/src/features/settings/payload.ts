...
export function buildSettingsUpdateRequest(
  ...
  const payload: SettingsUpdateRequest = {
    ...
    modelSourceStickyEnabled: settings.modelSourceStickyEnabled,
    modelSourceStickyTtlSeconds: settings.modelSourceStickyTtlSeconds,
    ...
    preferUnstartedQuotaAccounts: settings.preferUnstartedQuotaAccounts,
    preferUnstartedQuotaWindow: settings.preferUnstartedQuotaWindow,
    preferEarlierRenewalAccounts: settings.preferEarlierRenewalAccounts,
    ...
    globalApiRoutingOverride: settings.globalApiRoutingOverride,
    providerFailurePolicy: settings.providerFailurePolicy,
    accountFailurePolicy: settings.accountFailurePolicy,
    providerMaxAttempts: settings.providerMaxAttempts,
    accountMaxAttempts: settings.accountMaxAttempts,
    modelSourceAutoPauseEnabled: settings.modelSourceAutoPauseEnabled,
    modelSourceAutoPauseThreshold: settings.modelSourceAutoPauseThreshold,
