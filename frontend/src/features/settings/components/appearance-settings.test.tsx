...
describe("AppearanceSettings", () => {
  ...
  it("localizes the account burn projection row in vi", async () => {
    ...
    try {
      ...
      expect(screen.getByText("Dự báo mức tiêu thụ tài khoản")).toBeInTheDocument();
      expect(screen.getByText("Hiển thị thẻ dự báo số tài khoản tương đương trên bảng tổng quan.")).toBeInTheDocument();
